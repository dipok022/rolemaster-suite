...
Tags: roles, user roles, roles editor, capability
...
### Liked RoleMaster Suite Plugins?
Rate us on [WordPress Forum](https://wordpress.org/support/plugin/role-master-suite/reviews/#new-post) 🙂


== Source Code ==
[Source Code](https://github.com/litonarefin/role-master-suite)
...
If you like our RoleMaster Suite plugin then why not check some other plugins that developed by us:
